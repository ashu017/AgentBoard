...
// Refreshes the Supabase auth session cookie on each request (the documented
// SSR pattern) so Server Components see a valid session. Does NOT gate routes —
...
export const config = {
  // Run on app routes, but skip the bearer-authed MCP API, Next internals, and
  // static assets.
